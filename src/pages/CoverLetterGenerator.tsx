...
import { ArrowLeft, Sparkles, Copy, Download, Save, RefreshCw } from 'lucide-react';
...
export default function CoverLetterGenerator({ user, onBack }: CoverLetterGeneratorProps) {
  ...
  const downloadPDF = () => {
    ...
    const printContent = document.getElementById('cover-letter-content');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
              <h1 className="text-3xl font-bold text-slate-900 mb-6">AI Cover Letter Generator</h1>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  {activeTab === 'database' && (
                    ...
                    >
                      <option value="">None - Generate from job description only</option>
                      {resumes.map((resume) => (
                        <option key={resume.id} value={resume.id}>
                          {resume.title} ({resume.template_id})
                        </option>
                      ))}
                    </select>
                  )}
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">Choose how detailed you want your cover letter to be</p>
                </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-bold text-slate-900">Generated Cover Letter</h2>
                {generatedContent && (
              ...
              <div id="cover-letter-content" className="min-h-[500px] p-6 bg-slate-50 rounded-lg border border-slate-200">
                {generatedContent ? (
                  <div className="prose prose-slate max-w-none">
                    <textarea
                      value={generatedContent}
                      onChange={(e) => setGeneratedContent(e.target.value)}
                      className="w-full min-h-[450px] p-4 bg-white border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-900 focus:border-transparent outline-none resize-none"
                  ...
                  <div className="flex items-center justify-center h-[450px] text-slate-400">
                    <div className="text-center">
                      ...
                      <p className="text-sm mt-2">Fill in the details and click "Generate Cover Letter"</p>
                    </div>
                  </div>
                )}
              </div>
